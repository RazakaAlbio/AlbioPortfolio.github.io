    ...
    <div className="flex flex-row relative items-center justify-center min-h-[120vh] w-full h-full pb-20 -z-20">
      ...
      <div className="flex flex-col items-center justify-center translate-y-[150px] sm:translate-y-[200px] lg:translate-y-[250px] absolute z-[20] w-full max-w-4xl px-4">
        <div className="relative min-h-[700px]">
          ...
          {/* Timeline Items */}
          <div className="space-y-8 lg:space-y-20 py-12">
            {/* First Experience */}
            <div className="flex flex-col lg:flex-row lg:items-center">
               ...
               <div className="hidden lg:block w-1/2 pr-12 text-right">
              ...
              <div className="hidden lg:block w-1/2 pl-12"></div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center">
              ...
              {/* Desktop Layout */}
              <div className="hidden lg:block w-1/2 pr-12"></div>
